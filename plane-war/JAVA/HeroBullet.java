...
public class HeroBullet extends weapon {
    ...
    private void loadSound() {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("resources\\SOUND\\bullet.wav"));
    ...
    // 拷贝构造函数
    protected HeroBullet(HeroBullet T) {
        super(T);
    ...
    protected void init() {
        ...
        imagePath[0]="resources\\WEAPON\\bullet1.png";
        loadImages();
        loadSound();
    }
