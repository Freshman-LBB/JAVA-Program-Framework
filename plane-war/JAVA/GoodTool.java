...
public class GoodTool extends weapon {
    ...
    private void loadSound() {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("resources\\SOUND\\out_porp.mp3"));
    ...
    protected void activate(int x,int y)
    {
        state = true;
        img=0;
        setPositionX((int)(Math.random() * (960 - getWide()/2)));
    ...
    protected void init() {
        ...
        imagePath[0]="resources\\TOOL\\weapon1.png";
        loadImages();
        loadSound();
    }
